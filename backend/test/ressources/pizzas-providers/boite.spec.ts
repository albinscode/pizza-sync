...
// TODO To adapt for boite a pizza
// Start with testing the categories from static html
// Then change cinematics to start getting urls of pizzas by browsing the categories
// --> perhaps a mode fetchCategoryUrlMode shall be activated or else.
